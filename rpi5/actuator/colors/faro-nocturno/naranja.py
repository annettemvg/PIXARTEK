#!/usr/bin/env python3
"""
PIXARTEK — Color: Naranja (#F5A623) → ajustado
  Amarilla 88% + Roja 9% + Blanca 3%
"""
import time
import lgpio
...
BOMBAS = [
    ...
    {"name": "Amarilla", "in1": 25, "in2": 11, "pct": 0.88},
    {"name": "Blanca",   "in1": 14, "in2": 15, "pct": 0.03},
    {"name": "Negra",    "in1": 27, "in2": 17, "pct": 0.0},
    {"name": "Roja",     "in1": 23, "in2": 18, "pct": 0.09},
]
...
def dispensar(base_seconds=BASE_SECONDS):
    ...
    print(f"NARANJA — dosis {base_seconds}s")
    for b in BOMBAS:
        if b["pct"] > 0:
