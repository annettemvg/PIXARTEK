#!/usr/bin/env python3
"""
PIXARTEK — Color: Cadmium Orange (#f3682d) → [243, 104, 45]
  Roja 51% + Amarilla 29% + Blanca 17% + Negra 3%
"""
import time
import lgpio
...
BOMBAS = [
    ...
    {"name": "Amarilla", "in1": 25, "in2": 11, "pct": 0.29},
    {"name": "Blanca",   "in1": 14, "in2": 15, "pct": 0.17},
    {"name": "Negra",    "in1": 27, "in2": 17, "pct": 0.03},
    {"name": "Roja",     "in1": 23, "in2": 18, "pct": 0.51},
]
...
def dispensar(base_seconds=BASE_SECONDS):
    ...
    print(f"CADMIUM ORANGE — dosis {base_seconds}s")
    for b in BOMBAS:
        if b["pct"] > 0:
