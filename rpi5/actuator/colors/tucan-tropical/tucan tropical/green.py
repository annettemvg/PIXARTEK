...
BOMBAS = [
    {"name": "Azul",     "in1": 10, "in2": 9,  "pct": 0.28},
    {"name": "Amarilla", "in1": 25, "in2": 11, "pct": 0.55},
    {"name": "Blanca",   "in1": 14, "in2": 15, "pct": 0.12},
    {"name": "Negra",    "in1": 27, "in2": 17, "pct": 0.05},
...
def dispensar(base_seconds=BASE_SECONDS):
    ...
    print(f"GREEN — dosis {base_seconds}s")
    for b in BOMBAS:
        if b["pct"] > 0:
