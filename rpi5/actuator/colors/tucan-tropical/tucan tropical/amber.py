#!/usr/bin/env python3
"""
PIXARTEK — Color: Amber / Golden Yellow (~#FEB410)
  Amarilla[255,201,0] Roja[245,3,3] Blanca[255,255,255]
  Amarilla 82% + Roja 12% + Blanca 6%
  Verified: R=254 G=180 B=16
"""
import time
import lgpio
...
BOMBAS = [
    {"name": "Azul",     "in1": 10, "in2": 9,  "pct": 0.00},
    {"name": "Amarilla", "in1": 25, "in2": 11, "pct": 0.95},
    {"name": "Blanca",   "in1": 14, "in2": 15, "pct": 0.02},
    {"name": "Negra",    "in1": 27, "in2": 17, "pct": 0.00},
    {"name": "Roja",     "in1": 23, "in2": 18, "pct": 0.03},
]
...
def dispensar(base_seconds=BASE_SECONDS):
    ...
    print(f"AMBER — dosis {base_seconds}s")
    for b in BOMBAS:
        if b["pct"] > 0:
