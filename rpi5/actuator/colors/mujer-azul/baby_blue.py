#!/usr/bin/env python3
"""
PIXARTEK — Color: Baby Blue (#8DB4D8) → [141, 180, 216]
  Blanca 83% + Azul 15% + Roja 1% + Negra 1%
"""
import time
import lgpio
...
BOMBAS = [
    {"name": "Azul",     "in1": 10, "in2": 9,  "pct": 0.15},
    {"name": "Amarilla", "in1": 25, "in2": 11, "pct": 0.0},
    {"name": "Blanca",   "in1": 14, "in2": 15, "pct": 0.83},
...
def dispensar(base_seconds=BASE_SECONDS):
    ...
    print(f"BABY BLUE — dosis {base_seconds}s")
    for b in BOMBAS:
        if b["pct"] > 0:
