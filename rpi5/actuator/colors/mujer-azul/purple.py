#!/usr/bin/env python3
"""
PIXARTEK — Color: Purple (#7B3F8E) → [123, 63, 142]
  Azul 48% + Roja 35% + Blanca 15% + Negra 2%
"""
import time
import lgpio
...
BOMBAS = [
    {"name": "Azul",     "in1": 10, "in2": 9,  "pct": 0.48},
    {"name": "Amarilla", "in1": 25, "in2": 11, "pct": 0.0},
    {"name": "Blanca",   "in1": 14, "in2": 15, "pct": 0.15},
    {"name": "Negra",    "in1": 27, "in2": 17, "pct": 0.02},
    {"name": "Roja",     "in1": 23, "in2": 18, "pct": 0.35},
]
...
def dispensar(base_seconds=BASE_SECONDS):
    ...
    print(f"PURPLE — dosis {base_seconds}s")
    for b in BOMBAS:
        if b["pct"] > 0:
