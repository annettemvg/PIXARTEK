#!/usr/bin/env python3
"""
PIXARTEK — Ciclo Flores Blancas (posiciones guardadas)

HOME (sin mover)       → burnt_sienna.py
Parada #1:  60,338     → champagne.py
Parada #2: 129,148     → ivory_white.py
...
COLOR_INICIO = os.path.join(HERE, "burnt_sienna.py")

# Paradas con movimiento
PARADAS = [
    (60_338,  os.path.join(HERE, "champagne.py")),
    (129_148, os.path.join(HERE, "ivory_white.py")),
...
class CicloFloresBblancas:
    ...
    def correr(self):
        print("=" * 50)
        print("  CICLO FLORES BLANCAS — posiciones guardadas")
        print("=" * 50)
