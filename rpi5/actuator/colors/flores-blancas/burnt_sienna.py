#!/usr/bin/env python3
"""
PIXARTEK — Color: Burnt Sienna (#da874b)
  Amarilla 54% + Roja 24% + Blanca 18% + Negra 3% + Azul 1%
"""
import time
import lgpio
...
BOMBAS = [
    ...
    {"name": "Amarilla", "in1": 25, "in2": 11, "pct": 0.92},
    {"name": "Blanca",   "in1": 14, "in2": 15, "pct": 0.05},
...
def dispensar(base_seconds=BASE_SECONDS):
    ...
    print(f"BURNT SIENNA — dosis {base_seconds}s")
    for b in BOMBAS:
        if b["pct"] > 0:
