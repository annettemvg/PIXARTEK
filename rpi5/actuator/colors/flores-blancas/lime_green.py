#!/usr/bin/env python3
"""
PIXARTEK — Color: Lime Green (#bdce62)
  Amarilla 75% + Azul 15% + Blanca 10%
"""
import time
import lgpio
...
BOMBAS = [
    {"name": "Azul",     "in1": 10, "in2": 9,  "pct": 0.03},
    {"name": "Amarilla", "in1": 25, "in2": 11, "pct": 0.78},
    {"name": "Blanca",   "in1": 14, "in2": 15, "pct": 0.18},
...
def dispensar(base_seconds=BASE_SECONDS):
    ...
    print(f"LIME GREEN — dosis {base_seconds}s")
    for b in BOMBAS:
        if b["pct"] > 0:
