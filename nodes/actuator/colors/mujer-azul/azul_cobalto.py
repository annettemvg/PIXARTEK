#!/usr/bin/env python3
"""
PIXARTEK — Color: Azul Cobalto (#2d58a6) → [45, 88, 166]
...
BOMBAS = [
    {"name": "Azul",     "in1": 10, "in2": 9,  "pct": 0.78},
    {"name": "Amarilla", "in1": 25, "in2": 11, "pct": 0.0},
    {"name": "Blanca",   "in1": 14, "in2": 15, "pct": 0.08},
    {"name": "Negra",    "in1": 27, "in2": 17, "pct": 0.0},
    {"name": "Roja",     "in1": 23, "in2": 18, "pct": 0.14},
]
...
def dispensar(base_seconds=BASE_SECONDS):
    ...
    print(f"AZUL COBALTO — dosis {base_seconds}s")
    for b in BOMBAS:
        if b["pct"] > 0:
