#!/usr/bin/env python3
"""
PIXARTEK — Color: Champagne (#eae1ba) → [234, 225, 186]
  Blanca 91% + Amarilla 7% + Negra 1% + Roja 1%
"""
import time
import lgpio
...
BOMBAS = [
    {"name": "Azul",     "in1": 10, "in2": 9,  "pct": 0.01},
    {"name": "Amarilla", "in1": 25, "in2": 11, "pct": 0.15},
    {"name": "Blanca",   "in1": 14, "in2": 15, "pct": 0.80},
    {"name": "Negra",    "in1": 27, "in2": 17, "pct": 0.01},
...
def dispensar(base_seconds=BASE_SECONDS):
    ...
    print(f"CHAMPAGNE — dosis {base_seconds}s")
    for b in BOMBAS:
        if b["pct"] > 0:
