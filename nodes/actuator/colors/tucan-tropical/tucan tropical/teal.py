#!/usr/bin/env python3
"""
PIXARTEK — Color: Teal / Pantone 320 C (~#3AB5C3)
  Best approximation with available pigments
  Azul 55% + Blanca 38% + Amarilla 4% + Negra 3%
  Approx result: R=118 G=110 B=197
"""
import time
import lgpio
...
BOMBAS = [
    {"name": "Azul",     "in1": 10, "in2": 9,  "pct": 0.55},
    {"name": "Amarilla", "in1": 25, "in2": 11, "pct": 0.12},
    {"name": "Blanca",   "in1": 14, "in2": 15, "pct": 0.30},
    {"name": "Negra",    "in1": 27, "in2": 17, "pct": 0.02},
    {"name": "Roja",     "in1": 23, "in2": 18, "pct": 0.01},
]
...
def dispensar(base_seconds=BASE_SECONDS):
    ...
    print(f"TEAL — dosis {base_seconds}s")
    for b in BOMBAS:
        if b["pct"] > 0:
