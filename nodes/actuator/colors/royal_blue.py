#!/usr/bin/env python3
"""
PIXARTEK — Color: Royal Blue (#302493) → [48, 36, 147]
  Azul 63% + Blanca 14% + Negra 23%
"""
import time
import lgpio
...
BOMBAS = [
    {"name": "Azul",     "in1": 10, "in2": 9,  "pct": 0.63},
    {"name": "Amarilla", "in1": 25, "in2": 11, "pct": 0.00},
    {"name": "Blanca",   "in1": 14, "in2": 15, "pct": 0.14},
    {"name": "Negra",    "in1": 27, "in2": 17, "pct": 0.23},
...
def dispensar(base_seconds=BASE_SECONDS):
    ...
    print(f"ROYAL BLUE — dosis {base_seconds}s")
    for b in BOMBAS:
        if b["pct"] > 0:
