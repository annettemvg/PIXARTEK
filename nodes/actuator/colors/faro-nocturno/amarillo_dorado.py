#!/usr/bin/env python3
"""
PIXARTEK — Color: Amarillo Dorado (#F5C518) → [245, 197, 24]
  Azul 0% + Amarilla 0% + Blanca 0% + Negra 0% + Roja 0%
"""
import time
import lgpio
...
BOMBAS = [
    {"name": "Azul",     "in1": 10, "in2": 9,  "pct": 0.0},
    {"name": "Amarilla", "in1": 25, "in2": 11, "pct": 1.0},
    {"name": "Blanca",   "in1": 14, "in2": 15, "pct": 0.0},
    {"name": "Negra",    "in1": 27, "in2": 17, "pct": 0.0},
    {"name": "Roja",     "in1": 23, "in2": 18, "pct": 0.0},
]
...
def dispensar(base_seconds=BASE_SECONDS):
    ...
    print(f"AMARILLO DORADO — dosis {base_seconds}s")
    for b in BOMBAS:
        if b["pct"] > 0:
